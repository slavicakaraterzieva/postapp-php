...
<section class="comments">
 <h2 class="cool-heading">Add Your Comment</h2>
...
<div class="form-group">
 <label class="" for="comment_name">Enter yor name</label>
...
<div class="form-group">
 ...
 <input type="text" name="post_id" id="post_id" class="post-control hidden" value ="<?php echo trim($postInfo->post_id); ?>">
